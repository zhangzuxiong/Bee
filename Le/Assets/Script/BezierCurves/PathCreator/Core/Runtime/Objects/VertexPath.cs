...
namespace PathCreation {
    ...
    public class VertexPath {
        ...
        public readonly VertexPathUtility.PathSplitData splitData;
        ...
        VertexPath (BezierPath bezierPath, VertexPathUtility.PathSplitData pathSplitData, Transform transform) {
            // Debug.LogError("-----------------"+pathSplitData.vertices.Count);
            ...
            for (int i = 0; i < localPoints.Length; i++) {
                ...
                if (space == PathSpace.xyz) {
                    if (i == 0) {
                        ...
                        // Debug.LogError("-------"+JsonUtility.ToJson(lastRotationAxis)+"/"+JsonUtility.ToJson(pathSplitData.tangents[0]));
                    } else {
                        // First reflection
            ...
            // for (var index = 0; index < localNormals.Length; index++)
            // {
            //     var normal = localNormals[index];
            //     Debug.LogError("index:"+index+"/pos:"+JsonUtility.ToJson(normal));
            // }
        }
